    ...
    <div class='mx-auto max-w-6xl'>
      <header class='flex flex-wrap items-center justify-between gap-4'>
        <div>
          ...
          <p class='mt-2 text-slate-600'>
            Buat, buka, dan kelola collaboration board Anda.
          </p>
        </div>
      ...
      >
        ...
        <p class='mx-auto mt-3 max-w-md leading-7 text-slate-600'>
          Buat project pertama untuk mulai menyusun ide, sticky notes, drawing, dan
          collaboration board bersama tim.
        </p>
        ...
        <div class='grid gap-4 sm:grid-cols-2 lg:grid-cols-3'>
          ...
          >
            <div class='flex items-start justify-between gap-4'>
              ...
              <span class='mt-5 inline-flex text-sm font-semibold text-blue-600'>
                Open board →
              </span>
          </RouterLink>
        </div>
