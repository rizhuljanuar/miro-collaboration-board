  ...
  <main class="flex min-h-screen flex-col bg-slate-100">
    ...
    <section v-else-if="project" class="flex flex-1 items-center justify-center p-6">
      ...
      >
        ...
        <p class="mt-6 text-sm font-bold uppercase tracking-[0.2em] text-blue-600">Board ready</p>
        ...
        <p class="mx-auto mt-8 max-w-xl text-sm leading-6 text-slate-500">
          Pada FASE 4, area ini akan menjadi layout board dengan toolbar, color palette, undo/redo,
          sidebar, dan workspace canvas.
        </p>
      </div>
    </section>
  </main>
