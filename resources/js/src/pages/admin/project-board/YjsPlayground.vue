...
function updateBoardTitle(): void {
    ...
    const nextTitle =
        boardTitle.value === 'Product Discovery'
...
onMounted(() => {
    ...
    addLog('Y.Doc lokal berhasil dibuat.');
});
        ...
        <div class='mx-auto max-w-4xl'>
            <header>
                ...
                <p class='mt-3 max-w-2xl leading-7 text-slate-600'>
                    Playground lokal untuk memahami shared data structure Yjs sebelum state board
                    disinkronkan melalui WebSocket.
                </p>
            </header>

            <section class='mt-8 grid gap-6 lg:grid-cols-2'>
                <article class='rounded-2xl border border-slate-200 bg-white p-6 shadow-sm'>
                    <p class='text-sm font-bold uppercase tracking-[0.16em] text-violet-600'>
                        Y.Map
                    </p>
                ...
                <article class='rounded-2xl border border-slate-200 bg-white p-6 shadow-sm'>
                    <p class='text-sm font-bold uppercase tracking-[0.16em] text-amber-600'>
                        Y.Array
                    </p>

                    <h2 class='mt-2 text-xl font-bold text-slate-950'>
                        Shared sticky note list
                    </h2>
            ...
            <section class='mt-6 rounded-2xl border border-slate-200 bg-slate-950 p-6 text-slate-100 shadow-sm'>
                <p class='text-sm font-bold uppercase tracking-[0.16em] text-cyan-300'>
                    Observe log
                </p>
